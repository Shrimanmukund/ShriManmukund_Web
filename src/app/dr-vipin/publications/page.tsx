...
export default function DrVipinPublicationsPage() {
  const pieces = getAllKnowledgePieces().filter((p) => p.authorSlug === 'dr-vipin');
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <Breadcrumbs
          items={[
            ...
            { name: 'Research & Publications', url: '/dr-vipin/publications/' },
          ]}
        />

        <section className="my-8">
          <span className="text-xs font-semibold uppercase tracking-wider text-[#B8894A]">Academic & Clinical Output</span>
          <h1 className="font-serif text-3xl sm:text-4xl font-bold text-[#1B3A5B] mt-1 mb-4">
            Publications & Guides by Dr. Vipin Tongale
          </h1>
          <p className="text-sm sm:text-base text-[#5C4F3A] leading-relaxed mb-8 max-w-3xl">
            Evidence-based recovery playbooks, clinical comparisons, and procedural guides authored to educate patients and document surgical outcomes.
          </p>
